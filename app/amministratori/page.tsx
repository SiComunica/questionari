...
export default function AmministratoriDashboard() {
  ...
  function getFieldValue(item: any, field: string): any {
    const fieldMap: Record<string, any> = {
      ...
      // Sezione E - Preoccupazioni e obiettivi (ALLINEATO CON EXPORT DASHBOARD)
      'E1.1': () => item.preoccupazioni_futuro?.pregiudizi || 0,
      'E1.2': () => item.preoccupazioni_futuro?.mancanza_lavoro || 0,
      'E1.3': () => item.preoccupazioni_futuro?.mancanza_aiuto || 0,
      'E1.4': () => item.preoccupazioni_futuro?.mancanza_casa || 0,
      'E1.5': () => item.preoccupazioni_futuro?.solitudine || 0,
      'E1.6': () => item.preoccupazioni_futuro?.salute || 0,
      'E1.7': () => item.preoccupazioni_futuro?.perdita_persone || 0,
      'E1.8': () => item.preoccupazioni_futuro?.altro || 0,
      'E2.1': () => item.obiettivi_realizzabili?.lavoro_piacevole || 0,
      'E2.2': () => item.obiettivi_realizzabili?.autonomia || 0,
      'E2.3': () => item.obiettivi_realizzabili?.famiglia || 0,
  ...
  function getFieldLabel(field: string): string {
    const labels: Record<string, string> = {
      ...
      'E1.1': 'Pregiudizi nei miei confronti', 'E1.2': 'Mancanza lavoro', 'E1.3': 'Mancanza aiuto',
      'E1.4': 'Mancanza casa', 'E1.5': 'Solitudine', 'E1.6': 'Salute',
      'E1.7': 'Perdita persone', 'E1.8': 'Altro',
      'E2.1': 'Lavoro piacevole', 'E2.2': 'Autonomia', 'E2.3': 'Famiglia',
