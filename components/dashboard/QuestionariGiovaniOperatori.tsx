  ...
  const handleExportExcel = async (questionario?: QuestionarioGiovani) => {
    try {
      ...
      const mappedData = dataToExport.map(q => ({
        ...
        'B9': ((q as any).titolo_studio_madre || (q as any).madre?.titolo_studio || 0),
        'B10': ((q as any).situazione_lavorativa_madre || (q as any).madre?.situazione || 0),
        'B11': ((q as any).titolo_studio_padre || (q as any).padre?.titolo_studio || 0),
        'B12': ((q as any).situazione_lavorativa_padre || (q as any).padre?.situazione || 0),
