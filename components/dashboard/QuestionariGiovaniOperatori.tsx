  ...
  const handleExportExcel = async (questionario?: QuestionarioGiovani) => {
    try {
      ...
      const mappedData = dataToExport.map(q => ({
        ...
        'B8.1': q.famiglia_origine?.padre ? 1 : 0,
        'B8.2': q.famiglia_origine?.madre ? 1 : 0,
        ...
        'C2.2': (q.attivita_precedenti?.lavoravo_stabile || q.attivita_precedenti?.lavoravo_stabilmente) ? 1 : 0,
        'C2.3': (q.attivita_precedenti?.lavoravo_saltuario || q.attivita_precedenti?.lavoravo_saltuariamente) ? 1 : 0,
        ...
        'C2.5SPEC': q.attivita_precedenti?.altro_spec || q.attivita_precedenti?.altro_specificare || '',
        ...
        'C6': (Array.isArray((q as any).motivi_non_studio) && (q as any).motivi_non_studio.length > 0) ? parseInt((q as any).motivi_non_studio[0]) : (q.motivo_non_studio || 0),
        'C7': (q as any).corso_formazione?.descrizione || q.corso_frequentato || '',
        'C8': (q as any).lavoro_attuale?.descrizione || q.lavoro_attuale || '',
        ...
        'E3': q.aiuto_futuro || '',
        'E4': (typeof q.pronto_uscita === 'object' && q.pronto_uscita !== null && 'pronto' in q.pronto_uscita ? q.pronto_uscita.pronto : (q.pronto_uscita === true || q.pronto_uscita === 1)) ? 1 : 0,
        'E4.1': (typeof q.pronto_uscita === 'object' && q.pronto_uscita !== null && 'motivazione' in q.pronto_uscita && !q.pronto_uscita.pronto ? q.pronto_uscita.motivazione : q.pronto_uscita_perche_no) || '',
        'E4.2': (typeof q.pronto_uscita === 'object' && q.pronto_uscita !== null && 'motivazione' in q.pronto_uscita && q.pronto_uscita.pronto ? q.pronto_uscita.motivazione : q.pronto_uscita_perche_si) || '',
